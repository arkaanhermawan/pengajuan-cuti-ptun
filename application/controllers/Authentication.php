...
class Authentication extends CI_Controller {
	...
	private function _sendEmail($token, $type) {
        ...
        $config = [
            ...
            'smtp_user' => 'arkaanzh9@gmail.com',
            'smtp_pass' => 'eskf acys ushz aicc', // Replace with your Gmail App Password
            'smtp_port' => 465,
            'mailtype'  => 'html',
            'charset'   => 'utf-8',
            'newline'   => "\r\n"
        ...
        $this->email->from('arkaanzh9@gmail.com', 'E-Cuti | Pengadilan Tata Usaha Negara Bandung');
