		...
		if ($this->form_validation->run() == false) {
			...
			if ($upload_image) {
				...
				if ($this->upload->do_upload('photo')) {
					...
					if ($old_image != 'default.jpg' && file_exists(FCPATH . 'uploads/profiles/' . $old_image)) {
					...
					$this->session->set_flashdata('message', '
						<div class="alert alert-danger" role="alert">
							<i class="fas fa-exclamation-triangle fa-fw"></i> Upload failed: ' . $this->upload->display_errors() . '
